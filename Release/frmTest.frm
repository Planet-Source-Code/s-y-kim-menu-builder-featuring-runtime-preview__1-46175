...
Private Sub SaveFile(Index As eSaveFileType)
   ...
   Const DLGTITLE_SAVEAS_FORM As String = "¸Þ´º ÀúÀå Æû"
   Const DLGTITLE_SAVEAS_TEMPLATE As String = "¸Þ´º ÅÛÇÃ·¹ÀÌÆ® ÀúÀå"
   Const FF_VBF_FILE As String = "Visual Basic Æû/ÄÁÆ®·Ñ (*.frm;*.ctl;*.pag)" & _
                                                vbNullChar & "*.frm;*.ctl;*.pag" & vbNullChar
   Const FF_VBM_FILE As String = "Visual Basic ¸Þ´º ÅÛÇÃ·¹ÀÌÆ® (*.vbm)" & _
...
'Open file
   ...
   Const DIALOG_FORM As String = "Visual Basic Æû ÆÄÀÏ ¿­±â"
   Const DIALOG_TEMPLATE As String = "Visual Basic ¸Þ´º ÅÛÇÃ·¹ÀÌÆ® ÆÄÀÏ ¿­±â"
   Const FF_VBF_FILE As String = "Visual Basic Æû/ÄÁÆ®·Ñ (*.frm;*.ctl;*.pag)" & _
         vbNullChar & "*.frm;*.ctl;*.pag" & vbNullChar
   Const FF_VBM_FILE As String = "Visual Basic ¸Þ´º ÅÛÇÃ·¹ÀÌÆ® (*.vbm)" & _
         vbNullChar & "*.vbm" & vbNullChar
