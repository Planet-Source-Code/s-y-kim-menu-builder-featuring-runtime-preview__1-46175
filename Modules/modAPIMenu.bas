...
Public Const FF_ALL_FILE As String = "¸ðµç ÆÄÀÏ(*.*)" & vbNullChar & "*.*" & vbNullChar
Public Const FF_VBF_FILE As String = "Visual Basic Æû/ÄÁÆ®·Ñ (*.frm;*.ctl;*.pag)" & vbNullChar & "*.frm;*.ctl;*.pag" & vbNullChar
Public Const FF_VBM_FILE As String = "Visual Basic ¸Þ´º ÅÛÇÃ·¹ÀÌÆ® (*.vbm)" & vbNullChar & "*.vbm" & vbNullChar
Public Const DLGTITLE_SAVEAS_FORM As String = "ÆûÀ¸·Î ÀúÀåÇÏ±â"
Public Const DLGTITLE_SAVEAS_TEMPLATE As String = "¸Þ´º ÅÛÇÃ·¹ÀÌÆ®·Î ÀúÀåÇÏ±â"
Public Const DIALOG_FORM As String = "Æû ¿­±â"
Public Const DIALOG_IMPORTFORM As String = "Æû¿¡¼­ ¸Þ´º °¡Á®¿À±â"
Public Const DIALOG_TEMPLATE As String = "¸Þ´º ÅÛÇÃ·¹ÀÌÆ® ¿­±â"
Public Const DIALOG_IMPORTTEMPLATE As String = "¸Þ´º ÅÛÇÃ·¹ÀÌÆ® °¡Á®¿À±â"
Public Const ksLeft As String = "¿ÞÂÊ"
Public Const ksCenter As String = "°¡¿îµ¥"
Public Const ksRight As String = "¿À¸¥ÂÊ"
Public Const ksNone As String = "¾øÀ½"
#Else
         ...
         If VBA.Mid$(DirPathIn, i, 1) = "\" Then
            ...
            If hSearch <> INVALID_HANDLE_VALUE Then
               ...
               If wfd.dwFileAttributes And FILE_ATTRIBUTE_DIRECTORY Then
                  ...
                  '-- Type Library ¹öÀü: unsigned char cFileName[260];
